...
type ToyLanguage lang a = ((Language :|: (Predicate BasicProp :|: Connective BasicConn )) lang a)
...
instance (Eval con, Eval pred) => 
        LEval (Language :|: (Predicate pred :|: Connective con)) Form where
...
instance (Modelable (Int -> Bool) con, Modelable (Int -> Bool) pred) => 
        LModelable (Int -> Bool) (Language :|: (Predicate pred :|: Connective con)) Form where
